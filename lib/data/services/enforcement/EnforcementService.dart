...
class EnforcementService {
  ...
  Map<String, dynamic> _mapToApiFormat(Map<String, dynamic> data) {
    ...
    apiData['enfAction'] =
        _mapEnforcementActions(data['enforcementActionTaken']);
  ...
  String _mapEnforcementActions(dynamic actions) {
    final raw = actions?.toString().trim() ?? '';
    if (raw.isEmpty) return '';
    final codes = raw
        .split(',')
        .map((action) => _mapEnforcementAction(action.trim()))
