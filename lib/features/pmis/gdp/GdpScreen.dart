...
import 'package:pmis/commons/widgets/cards/GdpActivityCard.dart';
import 'package:pmis/features/pmis/gdp/widgets/GdpForm.dart';
      ...
      child: Row(
        children: [
          Expanded(
            ...
            child: _ActionButton(
              icon: Iconsax.add,
              label: "Create new GDP",
              onTap: () => GdpScreen()._showCreateNewModal(context),
            ),
          ),
...
class _ActivityListSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final activities = gdpController.filteredActivities;
      if (activities.isEmpty && gdpController.searchQuery.value.isNotEmpty) {
        return Container(
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) => AnimatedContainer(
          ...
          child: GdpActivityCard(activity: activities[index]),
        ),
      );
    });
  }
        ...
        Obx(() => Column(
              children: [
                ...
                _FilterDropdown(
                  ...
                  value: controller.filterCertificationStatus.value,
                  items: const ["Certified", "Not certified"],
                  onChanged: (value) =>
                      controller.filterCertificationStatus.value = value ?? '',
                ),
                const SizedBox(height: 16),
                _FilterDropdown(
