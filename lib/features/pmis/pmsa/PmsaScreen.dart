...
import 'package:pmis/commons/widgets/cards/PmsaActivityCard.dart';
      ...
      child: Row(
        children: [
          Expanded(
            ...
            child: _ActionButton(
              icon: Iconsax.add,
              label: "Create new PMSA",
              onTap: () => PmsaScreen()._showCreateNewModal(context),
            ),
          ),
...
class _ActivityListSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final activities = pmsaController.filteredActivities;
      if (activities.isEmpty && pmsaController.searchQuery.value.isNotEmpty) {
        return Container(
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) => AnimatedContainer(
          ...
          child: PmsaActivityCard(activity: activities[index]),
        ),
      );
    });
  }
