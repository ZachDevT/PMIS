...
class EnforcementScreen extends StatelessWidget {
  final EnforcementController controller = Get.find<EnforcementController>();

  EnforcementScreen({super.key});
      ...
      child: Row(
        children: [
          Expanded(
            ...
            child: _ActionButton(
              icon: Iconsax.add,
              label: "Create  Enforcement",
              onTap: () => EnforcementScreen()._showCreateNewModal(context),
            ),
          ),
          const SizedBox(
            width: 10,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Start by adding your first enforcement activity",
            style: TextStyle(
              fontSize: 14,
              color: dark ? Colors.grey[400] : Colors.grey[600],
            ),
