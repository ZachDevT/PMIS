...
import 'package:pmis/features/pmis/shiftmarket/widgets/ShiftMarketActivityCard.dart';
...
class ShiftMarketScreen extends StatelessWidget {
  final ShiftMarketController controller = Get.find<ShiftMarketController>();

  ShiftMarketScreen({super.key});
        ...
        children: [
          Expanded(
            ...
            child: _ActionButton(
              ...
              onTap: () => ShiftMarketScreen()._showCreateNewModal(context),
            ),
          ),
          const SizedBox(
            width: 10,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Start by adding your first shift market activity",
            style: TextStyle(
              fontSize: 14,
              color: dark ? Colors.grey[400] : Colors.grey[600],
            ),
