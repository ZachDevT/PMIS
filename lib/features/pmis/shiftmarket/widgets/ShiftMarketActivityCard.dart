...
class ShiftMarketActivityCard extends StatelessWidget {
  final ShiftMarketModel activity;
  final VoidCallback? onTap;

  const ShiftMarketActivityCard({
    super.key,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          'Complete shift market inspection information',
                          style:
