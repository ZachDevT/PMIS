...
class GdpActivityCard extends StatelessWidget {
  final GdpModel activity;

  const GdpActivityCard({super.key, required this.activity});
            ...
            Row(
              children: [
                _buildModernChip(
                  ...
                  _getCertStatusColor(activity.certStatus),
                ),
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        print('=== End GDP Activity Card Debug ===');
                    ...
                    // Only show GDP Specific Details if facility is not Closed
                    if (activity.facilityStatus != 0) ...[
                      const SizedBox(height: 24),
                      _buildModernDetailSection(
                        'GDP Specific Details',
                        HugeIcons.strokeRoundedDeliveryTracking01,
                        [
                          _buildModernDetailRow(
  ...
  Color _getCertStatusColor(int status) {
    switch (status) {
      case 1:
        return Colors.green; // Certified
      case 2:
        return Colors.orange; // Not certified
      default:
        return Colors.grey;
    }
  }
