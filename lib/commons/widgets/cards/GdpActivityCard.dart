...
class GdpActivityCard extends StatelessWidget {
            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getStatusColor(activity.certStatus).withOpacity(0.1),
                  ...
                  children: [
                    ...
                    _buildModernDetailSection(
                      ...
                      [
                        ...
                        _buildModernDetailRow(
                            'Recommended for GDP',
                            _getRecommendationText(activity.recommendedforGDP),
                            Iconsax.like),
                        _buildModernDetailRow(
                            'Inspector ID',
  ...
  Color _getCertStatusColor(int status) {
    switch (status) {
      case 1: return Colors.green; // Certified
      case 2: return Colors.orange; // Not certified
